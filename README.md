...
lib/
└── day17/
├── day17.dart # 📌 Day17 진입 파일 (기본 구조)<br>
├── day17const/
│ └── day17color.dart # 🎨 체스보드 및 화면 색상 상수 정의<br>
├── day17screen/
│ ├── day17chessboard.dart # ♟️ 컨테이너를 이용한 체스판 UI 구현 중
│ └── day17screen.dart # 🖼️ 색상/이미지를 지정된 위치에 출력하는 화면<br>
└── day17semiP/ # 🎬 영화 예매 앱 (팀 프로젝트)
├── day17semiP.dart # 🎥 메인 페이지 & 해리 포터 3 예매 (팀 코드 병합)
